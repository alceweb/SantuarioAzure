...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
        <table >
            <tr>
                ...
                <td >Direzione Pastorale e
                    <br />
                    Segreteria Pellegrinaggi</td>
                <td >Tel.&nbsp;&nbsp; 0363 3571
                    <br />
                    Fax&nbsp;&nbsp;&nbsp;0363 357203</td>
                <td >E-mail: <a href="mailto:info@santuariodicaravaggio.org">info@santuariodicaravaggio.org </a></td>
                <td >&nbsp;</td>
            </tr>
        </table><hr />
    ...
    <table class="tbl1" >
        <tr>
            <td colspan="2">
                Celebrazioni proprie del Santuario</td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                ore 16.00 Atto penitenziale (al Fonte) a Messa</td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                Dopo la Messa delle ore 16:00 Lodi alla Vergine (allo Speco)</td>
        </tr>
        </table>
    ...
    <table class="tbl1" >
        ...
        <tr>
            <td rowspan="2">
                ...
                <strong>delle persone</strong><br />
...
&nbsp;domenica, ogni giorno
        ...
        <tr>
            <td rowspan="2">
                ...
                <strong>degli autoveicoli</strong><br />
