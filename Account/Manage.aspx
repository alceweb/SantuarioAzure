<%@ Page Title="Gestisci account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="SantuarioAzure.Account.Manage" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button runat="server" Text="Rimuovi" CommandName="Delete" CausesValidation="false" 
                            ToolTip='<%# "Rimuovere i dati di accesso " + Item.ProviderDisplayName + " Rimuovere dati accesso da account personale" %>'
