...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    <div style="border: thin solid #FFFFFF; margin-left:10px; border-radius:20px; padding-right:10px; padding-left:10px; background-image: url('../Images/SfondoTabellaNews.png'); background-repeat: repeat;" >
        ...
        <asp:DropDownList ID="DropDownList1" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="Titolo" DataValueField="Id"></asp:DropDownList>
